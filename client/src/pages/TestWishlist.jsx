        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {itemToDelete && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Remove from Wishlist</h3>
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link
                to="/browse"
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700"
              >
                Browse More Items
              </Link>
            </div>
            <p className="text-sm text-gray-500">{data.wishlist.length} items in your wishlist</p>
          </div>
          
          <div className="space-y-4">
            {data.wishlist.map((item) => (
              <div key={item.item_id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200">
                <div className="flex">
                    ...
                    <div className="flex-1">
                      <div className="space-y-3">
                        <div className="flex items-baseline">
                          <span className="text-lg font-semibold text-gray-900">₹{item.rental_price}</span>
