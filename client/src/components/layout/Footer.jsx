        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              A platform for IITP students to rent and share items within the campus community.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:support@rentiitp.com" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  support@rentiitp.com
                </a>
              </li>
            </ul>
          </div>
